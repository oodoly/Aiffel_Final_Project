...
# installed.
TK_PREFIX='/Users/m2021/dev/final_project/backend/env_server'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/m2021/dev/final_project/backend/env_server'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/Users/m2021/dev/final_project/backend/env_server/lib -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/m2021/dev/final_project/backend/env_server/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/m2021/dev/final_project/backend/env_server/include'
...
# compiled.
TK_SRC_DIR='/Users/m2021/dev/final_project/backend/env_server/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/Users/m2021/dev/final_project/backend/env_server/lib -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/m2021/dev/final_project/backend/env_server/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/m2021/dev/final_project/backend/env_server/lib/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/m2021/dev/final_project/backend/env_server/lib/libtkstub8.6.a'
